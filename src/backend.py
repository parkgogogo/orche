...
from agents.common import normalize_runtime_home, remove_runtime_home, validate_discord_channel_id
...
def ensure_session(
    ...
    *,
    ...
    if resolved_discord_channel_id:
        resolved_discord_channel_id = validate_discord_channel_id(resolved_discord_channel_id)
